            ...
            <div class="bg-white shadow rounded-lg mb-6">
                ...
                <form action="{{ route('create.admin') }}" method="POST">
                    ...
                    <div class="w-full mt-4">
                        <div>
                            <label for="text-input-component-id-username"
                                class="block text-[0.8125rem] font-medium tracking-wide text-gray-700 dark:text-white">Admin Email</label>
                            <div class="mt-2 relative">
                                <input type="text" placeholder="Enter admin email" name="email"
                    ...
                    <div class="w-full mt-4">
                        <div>
                            <label for="text-input-component-id-username"
                                class="block text-[0.8125rem] font-medium tracking-wide text-gray-700 dark:text-white">Admin Username</label>
                            <div class="mt-2 relative">
                    ...
                    <div class="w-full mt-4">
                        <div>
                            <label for="text-input-component-id-username"
                                class="block text-[0.8125rem] font-medium tracking-wide text-gray-700 dark:text-white">Admin Password</label>
                            <div class="mt-2 relative">
