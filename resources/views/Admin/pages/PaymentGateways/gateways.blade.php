...
<a href="{{ route('add.gateway.view') }}"><button type="submit" class="btn btn-primary">Add New</button></a>
                            ...
                            <td>
                               ...
                               @endif
                                ...
                                @include('Admin/partials/buttons/edit', [
                                    'id' => $gateway->id,
                                    'title' => 'Edit Gateway',
                                    'route' => route('update.gateway.view', $gateway->id)
                                ])

                                @include('Admin/partials/dialogues/delete', [
                                    'id' => $gateway->id,
                                    'title' => 'Delete Gateway',
                                    'action' => route('delete.gateway', $gateway->id),
                                ])
                                ...
                                @include('Admin/partials/dialogues/block', [
                                    ...
                                    'hideForm' => true,
                                    'title' => 'Inactive Gateway',
                                    'action' => route('active.inactive.gateway', $gateway->id),
                                ])
