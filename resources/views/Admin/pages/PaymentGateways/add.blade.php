...
@section('title', 'Add Manual Gateways')

@include('Admin.partials.alerts.errors')

@include('Admin.partials.alerts.success')

<form action="{{ route('add.gateway') }}" method="post" enctype="multipart/form-data" id="gatewayForm">
    @csrf
    <div class="col-xl-12">
            ...
            <div style="margin-left: 1rem; margin-top: 1rem; margin-right: 1rem">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="any" class="form-control" name="rate" required="" value=""
                                    id="rate">
                                <div class="input-group-text"><span class="currency_symbol" id="currencyData"></span></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-4 mb-3">
                        <label for="input-rounded" class="form-label">Minimum Deposit<span class="small text-danger">*</span></label>
                        <div class="input-group">
                    ...
                    <div class="col-xl-4 mb-3">
                        <label for="input-rounded" class="form-label">Maximum Deposit<span class="small text-danger">*</span></label>
                        <div class="input-group">
